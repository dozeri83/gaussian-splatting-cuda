...
class ADMMSparsityOptimizerTest : public lfs::test::CudaBackendTest {};

TEST_F(ADMMSparsityOptimizerTest, ReinitializesWhenOpacityShapeChanges) {
...
TEST_F(ADMMSparsityOptimizerTest, StartsAfterRegularTrainingBoundary) {
    ADMMSparsityOptimizer optimizer(ADMMSparsityOptimizer::Config{
        .sparsify_steps = 3,
        .init_rho = 0.001f,
        .prune_ratio = 0.25f,
...
TEST_F(ADMMSparsityOptimizerTest, SerializeDeserializeRoundTrip) {
...
TEST_F(ADMMSparsityOptimizerTest, DeserializeRejectsWrongMagic) {
    std::stringstream stream;
...
TEST_F(ADMMSparsityOptimizerTest, LossForwardReinitializesAfterReset) {
    ADMMSparsityOptimizer optimizer(ADMMSparsityOptimizer::Config{
        .sparsify_steps = 100,
        .init_rho = 0.001f,
        .prune_ratio = 0.25f,
