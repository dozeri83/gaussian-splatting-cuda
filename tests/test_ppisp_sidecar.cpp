...
namespace {
    ...
    Tensor make_controller_input(float base, size_t height = 48, size_t width = 48) {
        ...
        return Tensor::from_vector(values, {1, 3, height, width}, Device::GPU);
    }
    ...
    class PPISPControllerPoolTest : public lfs::test::CudaBackendTest {};

    TEST_F(PPISPControllerPoolTest, PredictPreservesOutputAcrossInputSizes) {
