...
#else
        constexpr lfs::training::Trainer* getTrainer() { return nullptr; }
        constexpr const lfs::training::Trainer* getTrainer() const { return nullptr; }
#endif
...
#else
        static constexpr lfs::training::Trainer* trainer_ = nullptr;
#endif
