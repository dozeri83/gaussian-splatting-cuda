...
namespace lfs::core {
    ...
    namespace internal {
        ...
        void telemetry_record_expr_node(uint64_t count = 1);
        void telemetry_record_expr_node_drop(uint64_t count = 1);
        void telemetry_publish_expr_registry_counts(uint64_t live_nodes,
                                                    uint64_t live_tensor_mappings,
                                                    uint64_t node_limit);
        void telemetry_record_materialization(uint64_t bytes);
        void telemetry_record_kernel_launch(uint64_t count = 1);
