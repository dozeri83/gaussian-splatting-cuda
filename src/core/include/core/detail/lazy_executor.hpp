...
namespace lfs::core {
    ...
    namespace internal {
        ...
        LFS_LOCAL_SYMBOL void lazy_executor_register_deferred_materializer(uint64_t node_id,
                                                                           std::function<Tensor()> materializer,
        ...
        LFS_LOCAL_SYMBOL bool lazy_executor_memory_planner_enabled_for_testing();
        ...
        LFS_LOCAL_SYMBOL bool lazy_executor_try_consume_pointwise_fusion(
            uint64_t node_id, Tensor* out_source, std::vector<LazyPointwiseOp>* out_ops);

        LFS_LOCAL_SYMBOL void lazy_executor_diagnostics_counters_increment_fused();
        LFS_LOCAL_SYMBOL void lazy_executor_diagnostics_counters_increment_fused_reduce();
